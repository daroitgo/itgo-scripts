...
- LOGGUARD autonomicznie monitoruje wszystkie wykryte Platformy Integracyjne przez `logguard.timer`, uruchamiający bezpieczną kontrolę `catalina.out` co 30 minut, z rootowym wrapperem `/usr/local/sbin/itgo-logguard-run` jako punktem wykonania systemd.
